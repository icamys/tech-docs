...
```
Методы классификации — по функциональным областям, рабочим потокам, вариантам
использования, режимам работы, классам пользователей, стимулам и реак-
циям. Возможны также иерархические комбинации этих элементов, напри-
мер варианты использования внутри классов пользователей. Не существует
единственно правильного метода организации; выберите тот, при котором
пользователям будет легче понять предполагаемые возможности продукта.
```
